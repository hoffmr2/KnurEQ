...
//==============================================================================
LookAndFeelCustom::LookAndFeelCustom() : LookAndFeel_V3()
{
	
	myStrip = ImageCache::getFromMemory(BinaryData::eq_knob_32_png, BinaryData::eq_knob_32_pngSize);
...
//	File temp("G:/documents/doucments/KnurEQ/Source/eq_knob_32.PNG");
	// This is the binary image data that uses very little CPU when rotating
//	Image myStrip = ImageCache::getFromFile(temp);
...
void LookAndFeelCustom::createSliderButton(const bool isIncrement)
{
	if (isIncrement)
		return ;
	else
...
void LookAndFeelCustom::getSliderEffect()
{
	return ;
}
